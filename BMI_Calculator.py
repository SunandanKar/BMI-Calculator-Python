...
def BMI():
    ...
    if bmi<=18.5:
        ...
        label3.config(text="Health amy be at risk, \n Immediate doctor adivse is needed")
...
#top
top=PhotoImage(file="Image/top1.png")
...
Hei=PhotoImage(file="Image/Height.png")
Label(root,image=Hei).place(x=80,y=110)

Wei=PhotoImage(file="Image/Weight.png")
Label(root,image=Wei).place(x=300,y=110)
...
slider= ttk.Scale(root,from_=0,to=240,orient='horizontal',style="TScale",
...
height=Entry(root,textvariable=Weight,width=5,font='arial 50',bg="#fff",fg='#000',bd=0,justify=CENTER)
height.place(x=255,y=160)
Weight.set(get_current_value2())
...
label1=Label(root,font="arial 60 bold",bg="lightblue",fg='#fff',justify=CENTER)
label1.place(x=125,y=305)

label2=Label(root,font="arial 20 bold",bg="lightblue",fg='#3b3a3a',justify=CENTER)
label2.place(x=280,y=430)

label3=Label(root,font="arial 10 bold",bg="lightblue",justify=CENTER)
